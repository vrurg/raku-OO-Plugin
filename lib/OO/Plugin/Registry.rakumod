...
L<C<OO::Plugin>|../Plugin.md> and
L<C<OO::Plugin::Manager>|Manager.md> modules and
described in L<C<OO::Plugin::Manual>|Manual.md>.
...
L<C<OO::Plugin::Manual>|Manual.md> with
...
=end pod
    ...
    method !build-extended-classes {
        # note ">>> PLUG     CLASSES: ", %!registry<plug-classes>.raku;
        ...
        # note "!!! PLUG     CLASSES: ", %!registry<plug-classes>.raku;
        # note "!!! EXTENDED CLASSES: ", %!registry<extended-classes>.raku;
    }
...
L<C<OO::Plugin::Manager>|Manager.md>,
