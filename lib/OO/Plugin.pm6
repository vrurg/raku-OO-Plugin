...
Read more in L<OO::Plugin::Manual|https://github.com/vrurg/Perl6-OO-Plugin/blob/v0.0.4/docs/md/OO/Plugin/Manual.md>.
...
module OO::Plugin:ver<0.0.4>:auth<github:vrurg> {
